export const BIBLE_STORIES_DATA = [
  {
    id: 'creation',
    title: 'The Creation Story',
    summary: 'Learn how God created the world in seven days.',
    icon: '🌍',
    ...
    content: [
      ...
      {
        type: 'paragraph',
        text: "On the third day, God gathered the water into oceans and seas, and dry land appeared. He then covered the land with grass, flowers, and tall trees with delicious fruit."
      },
      {
        type: 'paragraph',
        text: "On the fourth day, God created the sun for the daytime, and the moon and stars for the nighttime. They shone brightly in the sky."
      },
      {
        type: 'paragraph',
        text: "On the fifth day, God made all the fish to swim in the water and all the birds to fly in the air. The world started to become a lively place!"
      },
      {
        type: 'paragraph',
        text: "On the sixth day, God created all the animals. He made big elephants, tall giraffes, and friendly dogs. Then, God made the first man and woman, Adam and Eve, to take care of the beautiful world."
      },
      {
        type: 'paragraph',
  ...
  },
  {
    id: 'noahs-ark',
    title: "Noah's Ark",
    summary: 'A story about a great flood and a giant boat.',
    icon: '⛵️',
    ...
    content: [
      ...
      {
        type: 'paragraph',
        text: "God told Noah to build a huge boat, called an ark. \"It must be very, very big,\" God said. \"You will take your family, and two of every kind of animal—a boy and a girl—into the ark.\""
      },
      {
        type: 'paragraph',
        text: "Noah did exactly as God commanded. He and his sons built the giant ark. When it was finished, the animals started coming. Two by two, elephants, lions, monkeys, and birds all went into the ark."
      },
      {
        type: 'paragraph',
        text: "After Noah, his family, and all the animals were safely inside, God shut the door. Then, the rain began to fall. It rained for forty days and forty nights, until the whole world was covered in water."
      },
      {
        type: 'paragraph',
        text: "The ark floated safely on the water. After many months, the rain stopped and the water went down. The ark rested on top of a mountain. Noah sent out a dove, and it came back with an olive leaf. This was a sign that the land was drying."
      },
      {
        type: 'paragraph',
  ...
  },
  {
    ...
    content: [
      ...
      {
        type: 'paragraph',
        text: "A young shepherd boy named David heard the giant. David was not a soldier, but he loved God very much. He said, \"I will fight the giant!\" Everyone was surprised. \"You are just a boy,\" they said."
      },
      {
        type: 'paragraph',
        text: "But David was brave. He knew God was with him. He didn't take a sword or armor. Instead, he took his slingshot and picked up five smooth stones from a stream."
      },
      {
        type: 'paragraph',
        text: "When Goliath saw David, he laughed. \"Am I a dog that you come at me with sticks?\" he roared. David replied, \"You come to me with a sword, but I come to you in the name of the Lord!\""
      },
      {
        type: 'paragraph',
  ...
  },
  {
    ...
    summary: 'A prophet learns a lesson inside a giant fish.',
    icon: '🐳',
    color: 'from-teal-400 to-blue-500',
    content: [
      {
        type: 'paragraph',
        text: "God asked a prophet named Jonah to go to a city called Nineveh and tell the people to be kind. But Jonah didn't want to go. He ran away and got on a boat going in the opposite direction."
      },
      {
        type: 'paragraph',
        text: "Suddenly, a huge storm started! The sailors were terrified. Jonah knew it was his fault, so he told them, \"Throw me into the sea, and the storm will stop.\" The sailors didn't want to, but the storm got worse. So, they threw Jonah into the raging water."
      },
      {
        type: 'paragraph',
        text: "As soon as Jonah hit the water, the storm stopped. But Jonah was sinking! Suddenly, God sent a giant fish to swallow Jonah whole. It was dark and wet inside the fish's belly."
      },
      {
        type: 'paragraph',
        text: "Jonah was inside the fish for three days and three nights. He prayed to God and said he was sorry for running away. He promised to obey God."
      },
      {
        type: 'paragraph',
