...
import { generateAdditionProblem } from '../../data/mathsData';
...
const Addition = () => {
  ...
  const generateNewProblem = useCallback(() => {
    const newProblem = generateAdditionProblem(20);
    ...
    // Speak the problem
    setTimeout(() => {
      speak(`What is ${newProblem.a} plus ${newProblem.b}?`, { rate: 0.7, pitch: 1.1 });
    }, 300);
  }, [speak]);
  ...
  const handleAnswer = (answer) => {
    ...
    if (correct) {
      ...
      // Adaptive learning
      adaptiveLearningService.recordPerformance('maths_addition', {
        correct: 1,
        incorrect: 0,
        time: 2,
        difficulty: 'easy'
  ...
  // Generate visual counters
  const renderCounters = (count) => {
    const emojis = ['⭐', '🔵', '🟢', '🔴', '🟡'];
    ...
    >
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-soft p-6 text-center">
        ...
        <div className="mt-4 flex flex-wrap justify-center gap-2">
          {renderCounters(problem.a)}
          <span className="text-2xl text-gray-400">+</span>
          {renderCounters(problem.b)}
        </div>

        <button
          onClick={() => speak(`${problem.a} plus ${problem.b} equals?`)}
          ...
          >
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-300 mt-2">
                You completed the addition challenge!
              </p>
